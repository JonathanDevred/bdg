...
const Article = ({ id, title, content, image, tags, showButtons }) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      if (token) {
        ...
        const response = await axios.delete(`${frontBackendUrl}/articles/${id}`, {
          headers: {
  ...
  return (
    <div className="article-container">
      ...
      <img className='article-picture' src={`${frontBackendUrl}/images/${encodeURIComponent(relativeImagePath)}`} alt={title} />
